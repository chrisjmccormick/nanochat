...
This variant uses a token pool (single contiguous tensor) instead of Python lists
for buffered documents, reducing GC pressure from many short-lived list objects.
"""
