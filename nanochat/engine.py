...
class Engine:
    ...
    def generate(self, tokens, num_samples=1, max_tokens=None, temperature=1.0, top_k=None, seed=42):
        ...
        # Get the special tokens that terminate a row
        ...
        while True:
            ...
            # Process each row: record the sampled token, update completion state
            token_column = [] # contains the next token id along each row
            token_masks = [] # 1 for every sampled token (0 is reserved for prompt tokens)
